 ...
 * strictfin  
 * standadjust    
 * jumpoverable : landable : bridgeable : buildstairable : scaffordable  
 * ignore  
 * continue  
 */
...
function bestFirstSearch(start, goal, reqOptions) {
    ...
    setStandable(start)
    if (!setStandable(goal, options.standadjust)) {
        bot.log("[move] stand adjust failed")
    }
